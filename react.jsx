                    ...
                    React.createElement('div', { className: 'grid md:grid-cols-2 gap-12 items-center' },
                            ...
                            React.createElement('div', { className: 'relative' },
                                React.createElement('div', { className: 'w-80 h-80 mx-auto bg-gradient-to-br from-purple-500 via-blue-500 to-pink-500 rounded-3xl flex items-center justify-center shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500' },
                                    React.createElement('img', {
                                        src: 'user.png',
                                        alt: 'Elsa Monteiro', alt: 'Elsa Monteiro',
                        ...
                        React.createElement('div', { className: 'space-y-6 transition-all duration-1000 delay-300' },
                            ...
                            React.createElement('p', { className: 'text-gray-300 leading-relaxed text-lg' },
                                'With a background in Marketing and Sales Management, I bring a unique blend of skills that help me create intuitive, user-friendly, and visually engaging web experiences. My understanding of user behavior, visual communication, and client needs allows me to design and develop websites that truly connect with people.'
                            ),
                            React.createElement('p', { className: 'text-gray-300 leading-relaxed text-lg' },
                                'I love combining creativity with logic — crafting clean, responsive, and modern interfaces that perform smoothly across all devices. Since 2021, I’ve been growing my skills in front-end technologies while continuously learning new tools to deliver impactful solutions.'
                            ),
                            React.createElement('div', { className: 'grid grid-cols-2 gap-4 pt-6' },
                                React.createElement('div', { className: 'glass-effect p-4 rounded-xl text-center' },
                                    ...
                                    React.createElement('div', { className: 'text-sm text-gray-400' }, 'Projets')
                                ),
                                React.createElement('div', { className: 'glass-effect p-4 rounded-xl text-center' },
                            ...
                            React.createElement('div', { className: 'space-y-6' },
                                [
                                    ...
                                    React.createElement('div', {
                                        ...
                                        React.createElement('div', { className: `w-14 h-14 bg-${contact.color}-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform` },
